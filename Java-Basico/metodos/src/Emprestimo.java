...
public class Emprestimo {
    ...
    public static void calcular(double valor, int parcelas){
        ...
        if(parcelas == 2){
            ...
            System.out.println("Valor final de 2 parcelas: R$" + valorFinal);
        } else if(parcelas == 3){
            double valorFinal = valor + (valor * getTaxaTresParcelas());

            System.out.println("Valor final de 3 parcelas: R$" + valorFinal);
        } else{
            System.out.println("Quantia de parcelas não aceita");
        }
